print("🍭PUBGM 0.7HAMBA ALLAH HA v1.9.0f 🍭")

gg.alert("🔘Do It Now, Remember It Later🔘")

gg.alert("PUBG MOBILE 0.7 FREE HA v1.9.0f\n🅾️YT Channel: HA Gaming FREAK")
gg.alert(os.date("Today: %Y/%m/%d Time: %H:%M:%S\nHambaAllah\nHA Gaming FREAK\nHappy Cheating!!🍭"))

gg.alert("👥Thanks for ALL MEMBER OF SADARJUGA👥")
...
"1️⃣LOBBY MENU•",
"2️⃣LANDING MENU•",
"3️⃣Other Function MENU•",
"4️⃣Emulator(Untested!!)•",
"🔴GoodBye👋•",
"           🅾️HambaAllah Contact🅾️"},nil,"PUBG MOBILE 0.7 FREE HA v1.9.0f\n🅾️YT Channel: HA Gaming FREAK")
if AB == 1 then BP() end
if AB == 2 then LOBB() end
if AB == 3 then WHCL() end
if AB == 4 then OLAND() end
if AB == 5 then EMN() end
if AB == 6 then HAM() end
if AB == 7 then CT() end
HambaAllah=-1
end
...
"🔓Bypass 1🛅",
"🔓Bypass 2🛅",
"🏠Home"},nil,"PUBG MOBILE 0.7 FREE HA v1.9.0f\n🅾️YT Channel: HA Gaming FREAK")
  if HAv0[1] == true then BP1() end
  if HAv0[2] == true then BP2() end
  if HAv0[3] == true then HOME() end
HambaAllah=-1
end
...
gg.searchNumber("1.1D;1.4D:2::10", gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
gg.clearResults(850)
gg.toast("☢️Hamba Allah☢️️")
gg.alert(os.date("Today: %Y/%m/%d Time: %H:%M:%S\nBypass Active !!\nHA Gaming FREAK\nHappy Cheating!!🍭"))
end

function WHCL()
HAv1 = gg.multiChoice({"🔘Perfect Wallhack",
    "🔘Wallhack - Snap430",
    "🔘Wallhack - Snap625",
    "🔘Wallhack - Snap660",
    "🔘Wallhack - Snap800+",
    "🔘Wallhack - Universal",
    "🔘Wallhack - Hentai*MyFav",
    "🔘Wallhack - Kirin",
    "🔘Wallhack - HDR",
    "💚Green Color",
    "🌈Mix Color",
    ...
    "🖤Pixel Color",
"🏠Home"},nil,"PUBG MOBILE 0.7 FREE HA v1.9.0f\n🅾️YT Channel: HA Gaming FREAK")
if HAv1[1] == true then PWH() end
if HAv1[2] == true then WH4() end
if HAv1[3] == true then WH62() end
if HAv1[4] == true then WH66() end
if HAv1[5] == true then WH80() end
if HAv1[6] == true then WHA() end
if HAv1[7] == true then WHH() end
if HAv1[8] == true then WHK() end
if HAv1[9] == true then WHDR() end
if HAv1[10] == true then CG() end
if HAv1[11] == true then CM() end
if HAv1[12] == true then CY() end
if HAv1[13] == true then CP() end
if HAv1[14] == true then CPX() end
if HAv1[15] == true then HOME() end
HambaAllah = -1
end
...
function CM()
   ...
   gg.toast("Mix Color Activated!")
end

function CG() -- New Green --
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
  gg.searchNumber("32,769;-2,134,900,722", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("32769", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
...
gg.toast('Loading Kirin Wallhack 1/3')
gg.clearResults()
gg.setRanges (gg.REGION_BAD)
...
gg.getResults(2)
gg.editAll("100", gg.TYPE_FLOAT)
gg.toast('Loading Kirin Wallhack 2/3')
gg.clearResults()
gg.setRanges (gg.REGION_BAD)
...
function WHH() -- Wallhack Mediatek
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
function WHA() -- Wallhack All SD
  ...
  gg.editAll("80", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Wallhack All SD Activated!")
end


function WH80() -- Wallhack SD 8xx
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
  ...
  gg.editAll("120", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Wallhack SD 800+ Activated!")
end

function WH66() -- Wallhack SD 660
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
gg.getResults(30)
gg.editAll("120", gg.TYPE_FLOAT)
gg.toast("Wallhack SD 430 Activated!")
end

function PWH() -- Perfect Wallhack
	gg.clearResults()
...
function LOBB()
HAv = gg.multiChoice({"🆎Ultra AimBot (NEW Remake)",
"🆎Ultra AimBot",
"🆎Medium AimBot",
"🆎Micro AimBot",
"🔷No Recoil (NEW)",
...
"➕Small Crosshair",
"🏠Home"},nil,"PUBG MOBILE 0.7 FREE HA v1.9.0f\n🅾️YT Channel: HA Gaming FREAK")
if HAv == nil then else
if HAv[1] == true then UAN() end
if HAv[2] == true then UAI() end
if HAv[3] == true then MEAI() end
if HAv[4] == true then MIAI() end
if HAv[5] == true then NRC1() end
if HAv[6] == true then NRC2() end
if HAv[7] == true then MB1() end
if HAv[8] == true then MB2() end
if HAv[9] == true then MB3() end
if HAv[10] == true then WTA() end
if HAv[11] == true then BLA() end
if HAv[12] == true then SMC() end
if HAv[13] == true then HOME() end
end
HambaAllah = -1
end
...
gg.clearResults() gg.toast("New Ultra AimBot Active!!")
  end
  
function NRC2() -- New No Recoil v2
gg.setRanges(gg.REGION_ANONYMOUS)
gg.clearResults()
...
gg.searchNumber('1', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1) 
gg.getResults(5000) 
gg.editAll('999', gg.TYPE_FLOAT) gg.toast('Loading Perfect White')
...
HAv2 = gg.multiChoice({
    -- Mostly used
    "🔶New Wallshoot *ComingSoon",
    "💙WALLSHOOT (BETA)",
    "💚No Grass",
    "💛No grass & No tree",
    "💜Extended View (Use in TPP Only)",
    -- Aim & Fire
    "💝Kar98k Instant Bullet (Pick Up Weapon)",
    "💖SCAR Fire Rate (Pick Up Weapon)",
    "💗AKM Fire Rate (Pick Up Weapon)",
    "💟M4A1 Fire Rate (Pick Up Weapon)",
    "💥Aimlock (Pick Up Weapon)", 
    -- Antenna
    "💜Running Antenna",
    "❣️Hand and Foot Antenna",
    "💓Backpack Antenna",
    "💛Standing Antenna",
    "💚High Level Items Antenna(Once)",
    "💙Head Antenna(Dont Use in FPP)",
    -- Vehicles
    "💝Jeep Acceleration",
    "💞Jeep Underwater",
    "💕Climbing UAZ",
    ...
    "💥Item Wallhack",
    -- Misc
    "💗Speedhack (Sometime Lag)",
    "💕Micro Speedhack",
    "💛Fast Walk+Long Jump",
    "💚Multijump (Use carefully)",
    "💜Big Helmet",
    "💖Less Gravity(Once)",
    "💝High View(Pick Up Weapon, Crouch and Scope)",
    "🔸Big Character",
    "💙Small Character",
    "🏠Home",},nil,"PUBG MOBILE 0.7 FREE HA v1.9.0f\n🅾️YT Channel: HA Gaming FREAK")
